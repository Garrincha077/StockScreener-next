...
export default function Root(){
  ...
  return <>
    {view==='groups'?<GroupsPage onBack={()=>setView('terminal')} onOpenTicker={openTicker}/>:<><DeepVueTerminal/><OriginalEngineDock/><button className="dv-groups-launch" onClick={()=>setView('groups')}>◎ Groups</button></>}
