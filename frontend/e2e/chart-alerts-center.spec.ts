...
test('global alerts center summarizes all tickers and opens the selected drawing manager',async({page})=>{
  ...
  await expect(center.getByRole('button',{name:/Active/})).toContainText('1')
  await expect(center.getByRole('button',{name:/Near Trigger/})).toContainText('1')
  await expect(center.getByRole('button',{name:/Triggered/})).toContainText('1')
  await expect(center.getByRole('button',{name:/Paused/})).toContainText('1')
  await expect(center.getByRole('button',{name:/All Drawings/})).toContainText('2')

  await center.getByRole('button',{name:/Near Trigger/}).click()
  ...
  await center.getByRole('button',{name:/Triggered/}).click()
  ...
  await center.getByRole('button',{name:/All Drawings/}).click()
