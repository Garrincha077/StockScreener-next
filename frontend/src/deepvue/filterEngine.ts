...
export const fieldDefs:FieldDef[]=[
  ...
  {id:'neglectedLaunchScore',label:'Neglected Launch 0-100',kind:'number',defaultOp:'>='},
...
export const builtInScreens:ScreenState[]=[
  ...
  {
    name:'Group-confirmed Early Leaders',rootLogic:'ALL',recipe:'All',query:'',pageSize:100,visibility:{groupRank:true,groupRS:true,groupConfidence:true,leadershipScore:true},
    sorting:[{id:'leadershipScore',desc:true},{id:'groupConfidence',desc:true},{id:'groupRank',desc:true},{id:'rsRank',desc:true}],
    groups:[
      group('ANY',[rule('stage','=','1'),rule('stage','=','2')]),
      group('ALL',[rule('rsRank','>=','70'),rule('rsAcceleration','>','0'),rule('distance10w','between','-8,10'),rule('groupConfidence','>=','35'),rule('groupRank','>=','60'),rule('extended','false')]),
    ],
  },
  {
